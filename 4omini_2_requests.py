...
with open(f"responses_{model_name}_2.jsonl", "a", encoding="utf-8") as log_file:
    indexs=read_index_from_file("failure_qwen-72b_2_index.txt")
    ...
    for index, payload in enumerate(payloads): 
        ...
        if not success:
            ...
            save_index_to_file([index],f"failure_{model_name}_2_index.txt")

# 保存更新后的数据
output_filename = f"updated_data_{model_name}_2.json"
